    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <ul class="space-y-2">
                <?php 
                // Vérifier si $services existe et n'est pas vide
                if (!empty($services)) {
                    // Limiter à 5 services maximum
                    $servicesToShow = array_slice($services, 0, 5);
                    foreach ($servicesToShow as $service): 
                        // Vérifier que le service a bien un nom
                        $serviceName = $service['nom'] ?? 'Service sans nom';
                ?>
                <li>
                ...
                <?php 
                    ...
                    echo '<li class="text-gray-400">Aucun service disponible</li>';
                }
                ?>
            </ul>
        </div>
